...
class GetCapturedPokemonUseCase {
  ...
  GetCapturedPokemonUseCase({required this.pokemonRepository});
  
  final PokemonRepository pokemonRepository;
  
  Future<Either<Failure, List<PokemonEntity>>> call(int id) {
    return pokemonRepository.getCapturedPokemon(id);
  }
}